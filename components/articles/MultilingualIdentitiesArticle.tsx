    ...
    <div className="pt-24 animate-fade-in">
      ...
      <section className="bg-navy py-16 md:py-24 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-block p-1 px-3 bg-beige text-navy text-[10px] font-bold uppercase tracking-widest mb-4">
          ...
          <p className="text-beige text-xl md:text-2xl italic mb-8">Our languages, our stories</p>
          <div className="w-16 h-1 bg-beige mx-auto mb-8"></div>
          <p className="text-beige/80 text-sm md:text-base max-w-3xl mx-auto leading-relaxed">
      ...
      <article className="py-16 md:py-24 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-700 leading-relaxed text-lg first-letter:text-5xl first-letter:font-serif first-letter:text-navy first-letter:float-left first-letter:mr-3 first-letter:mt-1">
          ...
          <section className="mt-12">
            <h2 className="text-3xl font-serif text-navy mb-6">Setting the scene</h2>
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mt-12">
            <h2 className="text-3xl font-serif text-navy mb-6">Collaborative text-making: "Our languages, our stories"</h2>
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed">
              ...
              <blockquote className="border-l-4 border-royal bg-beige-light p-6 my-8 italic text-gray-700">
          ...
          <section className="mt-12">
            <h2 className="text-3xl font-serif text-navy mb-6">Leveraging students' entire meaning-making resources</h2>
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed">
              ...
              <figure className="my-10">
                <div className="bg-beige-light p-4 rounded-sm shadow-lg">
                  <img
          ...
          <section className="mt-12">
            <h2 className="text-3xl font-serif text-navy mb-6">Where do we go next?</h2>
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed">
              ...
              <ul className="space-y-4 mt-6 text-gray-700">
                <li className="flex items-start">
                  <span className="text-royal mr-3 mt-1"><i className="fas fa-check-circle"></i></span>
                  <span>Increase institutional support for home languages and open up language learning provision to all students who wish to study a language regardless of cultural background;</span>
                </li>
                <li className="flex items-start">
                  <span className="text-royal mr-3 mt-1"><i className="fas fa-check-circle"></i></span>
                  <span>Break down boundaries that often create divides between languages as medium of instruction, foreign languages and home languages;</span>
                </li>
                <li className="flex items-start">
                  <span className="text-royal mr-3 mt-1"><i className="fas fa-check-circle"></i></span>
                  <span>Raise the visibility of home languages in the school and as a legitimate resource for learning for all students through a pedagogical stance that supports the entire repertoire of students' languages, heritages and identities;</span>
                </li>
                <li className="flex items-start">
                  <span className="text-royal mr-3 mt-1"><i className="fas fa-check-circle"></i></span>
                  <span>Emphasise the importance of translanguaging as pedagogical strategy in content areas and normalise the use of multiple languages as legitimate resources for learning;</span>
                </li>
                <li className="flex items-start">
                  <span className="text-royal mr-3 mt-1"><i className="fas fa-check-circle"></i></span>
                  <span>Create pedagogical spaces that not only acknowledge multilingualism and linguistic diversity but also create opportunities for students to use their multilingual resources and multiple cultural experiences.</span>
                </li>
              </ul>
            </div>
          </section>
          ...
          {/* References */}
          <section className="mt-16 pt-8 border-t border-beige-accent">
            <h3 className="text-2xl font-serif text-navy mb-6">References</h3>
          ...
          {/* Author Bios */}
          <section className="mt-12 pt-8 border-t border-beige-accent">
            <h3 className="text-2xl font-serif text-navy mb-6">About the Authors</h3>
            <div className="bg-beige-light p-6 rounded-sm">
              <div className="text-sm text-gray-700 space-y-4">
                <p><strong className="text-navy">Dr Vally Lytra</strong> is Reader in Languages in Education, at the Department of Educational Studies, Goldsmiths, University of London. Her two children are enrolled at the International School of Lausanne.</p>
                <p><strong className="text-navy">Soukeina Tharoo</strong> is the coordinator of the Home Language Programme and an EAL teacher at the International School of Lausanne.</p>
                <p><strong className="text-navy">Emanuela Banfi</strong> (Italian), <strong className="text-navy">Zhan Chengyan</strong> (Mandarin), <strong className="text-navy">Carla Costa</strong> (Portuguese), <strong className="text-navy">Maria Eleftheriou-Kaparti</strong> (Greek), <strong className="text-navy">Zoe Meyer</strong> (French) and <strong className="text-navy">Polina Schmid-Ilina</strong> (Russian) are home language teachers at the International School of Lausanne.</p>
              </div>
            </div>
          </section>
      ...
      {/* Navigation Back */}
      <section className="py-12 bg-beige-light border-t border-beige-accent/10">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <Link to="/resources" className="text-navy/50 hover:text-navy transition-colors text-sm uppercase tracking-widest font-bold inline-flex items-center gap-2">
