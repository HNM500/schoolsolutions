        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div className="text-gray-700 leading-relaxed space-y-5 text-base">
              ...
              <p>
                As a seasoned <strong className="text-navy">IB Workshop Leader</strong> and <strong className="text-navy">CIS Evaluation Team Chair</strong>, I possess a holistic view of the educational landscape. My work isn't just about implementing systems; it's about understanding the unique cultural fabric of each institution I partner with. I bridge the gap between high-level oversight and the day-to-day realities of pedagogical innovation.
              </p>

              <div className="bg-beige-light p-6 border-l-4 border-royal">
                <h3 className="text-xl font-serif text-navy mb-3 italic">The Multilingual Advantage</h3>
